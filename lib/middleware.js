...
(function() {
  ...
  exports.authWorker = function(req, res, next) {
    ...
    if (!((signature != null) && signature.indexOf("NodeTicketManager") === 0)) {
    ...
    Worker.findById(workerId, function(err, worker) {
      ...
      if (oauth.verify(signature, req.method, req.url, req.body, worker['consumer_secret']) && (worker.trashed_at == null)) {
        req.worker = worker;
        next();
      } else {
